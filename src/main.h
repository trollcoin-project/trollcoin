...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 TRC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 TRC mininput
/** Largest possible transaction (or it is ignored by the network) */
static const int64 MAX_MONEY = 420480000 * COIN;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; // 1440 blocks/day
    }
