Trollcoin-Qt: Qt4 GUI for Trollcoin
===============================
...
Alternatively, install `Qt Creator`_ and open the `trollcoin-qt.pro` file.
...
- If using HomeBrew,  edit `trollcoin-qt.pro` to account for library location differences. There's a diff in `contrib/homebrew/bitcoin-qt-pro.patch` that shows what you need to change, or you can just patch by doing

        patch -p1 < contrib/homebrew/bitcoin.qt.pro.patch

- Open the trollcoin-qt.pro file in Qt Creator and build as normal (cmd-B)
...
The static binary version of Trollcoin is linked against libdb4.8 (see also `this Debian issue`_).
